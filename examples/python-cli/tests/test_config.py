...
import unittest
import yaml
from piemakerexample.config import load
...
class TestConfig(unittest.TestCase):
    ...
    @patch('piemakerexample.config.init')
    def test_load_with_properties(self, func_init, func_open): # pylint: disable=unused-argument
        with open('piemakerexample.yaml', 'r', encoding='utf8') as file_handle:
        ...
        conf = load('piemakerexample.yaml')
